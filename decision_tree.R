...
cleveland <-read_csv("~/Desktop/processed.cleveland.data.txt", col_names=FALSE)
hungary <- read_csv(file="~/Desktop/processed.hungarian.data.txt",col_names=FALSE)
va <- read_csv(file="~/Desktop/processed.va.data.txt",col_names=FALSE)
swiss <- read_csv(file="~/Desktop/processed.switzerland.data.txt",col_names=FALSE)
